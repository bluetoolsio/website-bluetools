    ...
    <div className="flex min-h-screen flex-col overflow-hidden">
      <section className="relative overflow-hidden px-4 pb-20 pt-24 sm:px-6 md:pb-28 md:pt-32 lg:px-8">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <FadeIn direction="up" delay={0.25} className="tech-frame mx-auto mt-16 max-w-6xl p-3 sm:p-4">
            <Link
            ...
            >
              <div className="flex flex-col justify-between border border-white/10 bg-[#080b12]/95 p-6 md:border-r-0 lg:p-7">
                <div>
              ...
              <div className="relative min-h-[300px] overflow-hidden border border-white/10 bg-[#0b0b0c]">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn direction="up">
            <div className="mx-auto mb-14 max-w-3xl text-center">
              ...
              <h2 className="mt-4 font-mono text-2xl font-bold uppercase tracking-[0.08em] text-white md:text-4xl">
            ...
            {[
              ...
              <FadeIn key={String(title)} direction="up" delay={index * 0.1}>
                <Card hoverEffect className="h-full border-white/10 bg-black/28 p-7">
                  ...
                  <h3 className="mb-3 font-mono text-xl font-bold uppercase tracking-[0.04em] text-white">{title as string}</h3>
        ...
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <FadeIn direction="up">
            <div className="mx-auto mb-7 grid w-fit grid-cols-[6.5rem_3.5rem_6.5rem] items-center gap-2 sm:grid-cols-[8rem_3.5rem_8rem] sm:gap-4">
              <span className="inline-flex h-10 items-center justify-center gap-2 border border-white/10 bg-black/28 px-2 text-[0.65rem] uppercase tracking-[0.18em] text-muted-foreground sm:px-3 sm:text-xs sm:tracking-[0.2em]"><Gauge className="h-3.5 w-3.5 text-cyan-100" /> Fast</span>
              <span className="inline-flex h-14 w-14 items-center justify-center border border-cyan-200/20 bg-black/35 text-cyan-100">
                <OctoPieIcon className="h-8 w-8" />
              </span>
              <span className="inline-flex h-10 items-center justify-center gap-2 border border-white/10 bg-black/28 px-2 text-[0.65rem] uppercase tracking-[0.18em] text-muted-foreground sm:px-3 sm:text-xs sm:tracking-[0.2em]"><Sparkles className="h-3.5 w-3.5 text-cyan-100" /> Focused</span>
            </div>
            <h2 className="font-mono text-3xl font-bold uppercase tracking-[0.08em] md:text-5xl">Start with OctoPie.</h2>
